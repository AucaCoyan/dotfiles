...
# PROMPTS
$env.PROMPT_MULTILINE_INDICATOR = (^"/home/linuxbrew/.linuxbrew/Cellar/oh-my-posh/19.8.2/bin/oh-my-posh" print secondary $"--config=($env.POSH_THEME)" --shell=nu $"--shell-version=($env.POSH_SHELL_VERSION)")
